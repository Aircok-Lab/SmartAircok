...
export const categoriseq = new Map<string, any>([['pm10', {text : '미세먼지', eng : 'PM10', range : [25, 50, 75], unit : '㎍/㎥'}], // 0~25  25~50  50~75  75~ 나눠지는 기준값 표기
                                            ['pm25', {text : '초미세먼지', eng : 'PM25', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['tem', {text : '온도', eng : 'Temperature', range : [25, 50, 75], unit : '°C'}],
                                            ['hum', {text : '습도', eng : 'Humidity', range : [25, 50, 75], unit : '%'}],
                                            ['pm1', {text : '극초미세먼지', eng : 'PM1', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['hcho', {text : '폼알데하이드', eng : 'HCHO', range : [25, 50, 75], unit : 'ppb'}],
                                            ['co2', {text : '이산화탄소', eng : 'CO2', range : [25, 50, 75], unit : 'ppm'}],
                                            ['co', {text : '일산화탄소', eng : 'CO', range : [25, 50, 75], unit : 'ppm'}],
                                            ['vocs', {text : '유기화합물', eng : 'VOCs', range : [25, 50, 75], unit : 'ppb'}],
                                            ['reserve1', {text : '부가 센서 1', eng : 'etc1', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['reserve2', {text : '부가 센서 2', eng : 'etc2', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['reserve3', {text : '부가 센서 3', eng : 'etc3', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['reserve4', {text : '부가 센서 4', eng : 'etc4', range : [25, 50, 75], unit : '㎍/㎥'}],
                                            ['reserve5', {text : '부가 센서 5', eng : 'etc5', range : [25, 50, 75], unit : '㎍/㎥'}]])
