...
export const categoriseq = new Map<string, any>([['pm10', {text : '미세먼지', range : [25, 50, 75]}], // 0~25  25~50  50~75  75~ 나눠지는 기준값 표기
                                            ...
                                            ['pm1', {text : 'pm1', range : [25, 50, 75]}],
                                            ['hcho', {text : 'hcho', range : [25, 50, 75]}],
                                            ['co2', {text : 'co2', range : [25, 50, 75]}],
                                            ['co', {text : 'co', range : [25, 50, 75]}],
                                            ['vocs', {text : 'vocs', range : [25, 50, 75]}],
                                            ['reserve1', {text : 'reserve1', range : [25, 50, 75]}],
                                            ['reserve2', {text : 'reserve2', range : [25, 50, 75]}],
                                            ['reserve3', {text : 'reserve3', range : [25, 50, 75]}],
                                            ['reserve4', {text : 'reserve4', range : [25, 50, 75]}],
                                            ['reserve5', {text : 'reserve5', range : [25, 50, 75]}]])
